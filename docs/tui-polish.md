...
## Current state (keybinds verified at v0.6.1)
...
- Keybinds (v0.6.1): `Esc` is the layered key — completion → selection →
...
- `cargo test` (805 green baseline) + `cargo clippy --all-targets -- -D warnings`
  + `cargo fmt --all --check`.
